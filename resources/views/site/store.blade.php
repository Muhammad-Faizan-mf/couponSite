...
@section('content')
            ...
            <main class="lg:w-3/4 w-full">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach ($coupons as $coupon)
                        <div {{-- @dd($coupon) --}}
                            class="border border-gray-200 rounded-lg shadow-sm p-5 bg-white hover:shadow-md transition">
                            <div class="flex items-center space-x-3 mb-3">
                                <a href="/store">
                                    <img src="{{ asset('images/brands/'.$store->image) }}" alt="Amazon"
    ...
    <section class="bg-white px-4 py-10 sm:px-6 lg:px-8 max-w-5xl mx-auto rounded-xl shadow-md">
        ...
        <p class="text-gray-700 text-sm sm:text-base mb-6 leading-relaxed">
            ...
            partner with trusted brands and only list offers we’d use ourselves—because your trust is our top priority. When
            you visit Captain Discounts, you can shop with confidence, knowing you're getting the best, most up-to-date
            deals available.
        </p>
        ...
        <div class="space-y-6 text-gray-800">
            <div>
                ...
                <p class="text-sm sm:text-base mt-1">
                    CaptainDiscounts.com is a leading coupon and deals website that helps shoppers save money with verified
                    coupon codes, promo codes, and discounts from thousands of popular online retailers and brands. Our
                    mission is to make saving money easy and accessible for everyone.
                </p>
            </div>
            ...
            <div>
                ...
                <p class="text-sm sm:text-base mt-1">
                    Using a coupon code is simple: Just click on the 'Get Code' button next to the coupon you want to use.
                    The code will be revealed and automatically copied to your clipboard. We'll then redirect you to the
                    retailer's website where you can paste the code at checkout in the designated promo code or coupon code
                    field.
                </p>
            </div>
            ...
            <div>
                ...
                <p class="text-sm sm:text-base mt-1">
                    We strive to maintain the most accurate and up-to-date coupon database possible. Our team regularly
                    verifies coupon codes and removes expired offers. However, retailers may change or invalidate codes
                    without notice. If you find an invalid code, please let us know, and we'll update our database promptly.
                </p>
            </div>
            ...
            <div>
                ...
                <p class="text-sm sm:text-base mt-1">
                    No, CaptainDiscounts.com is completely free to use and doesn't require registration to access our coupon
                    codes. However, creating a free account allows you to save your favorite stores, get personalized deal
                    alerts, and track your savings over time.
                </p>
            </div>
            ...
            <div>
                ...
                <p class="text-sm sm:text-base mt-1">
                    The best way to find deals is to search for your favorite store in our search bar or browse our
                    categories. Sort results by popularity, value, or newest to find the best deals. For maximum savings,
                    check our blog for money-saving tips and strategies for combining offers. You can also sign up for our
    ...
    <section class="py-12 px-4 md:px-12">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="relative">
                ...
                <div id="logoSlider" class="flex gap-6 overflow-x-auto whitespace-nowrap scroll-smooth md:hidden"
